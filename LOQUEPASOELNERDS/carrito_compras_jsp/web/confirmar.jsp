<%-- 
    Document   : confirmar
    Created on : 02-oct-2017, 16:42:33
    Author     : Bazan
--%>
...
<%
    if(!request.getParameter("numero_tarjeta").isEmpty() && !request.getParameter("titular_tarjeta").isEmpty()){
        ...
        factura.setId_usuario(usuario.getId());
        factura.setFecha((fechaActual));
        factura.setTitular_tarjeta(request.getParameter("titular_tarjeta"));
        factura.setNumero_tarjeta(request.getParameter("numero_tarjeta"));
        factura.setMonto(carrito.sumarMontoProductos());
        
        CarritoRN guardar= new CarritoRN();
        guardar.guardarFactura(factura,carrito);
